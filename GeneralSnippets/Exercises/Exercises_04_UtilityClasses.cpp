...
namespace Exercises_UtilityClasses {
    ...
    namespace Exercise_02_Simple {
        ...
        public:
            ...
            virtual size_t getCount() const = 0;  // abstract
        };

        class BookEx : public IMedia
        {
        private:
            std::string m_author;
            std::string m_title;
        ...
        public:
            BookEx () {}
            BookEx(std::string author, std::string title, double price, size_t count)
            ...
            size_t getPriceDirect() const { return m_price; }
        };
        ...
        {
        private:
            using Stock = std::vector<std::variant<Book, Movie>>;

            using StockList = std::initializer_list<std::variant<Book, Movie>>;
        ...
        public:
            ...
            double totalBalance() {
                ...
                for (const auto& media : m_stock) {   // std::variant
    ...
    namespace Exercise_02 {
        ...
        // Book, DVD, CD, Magazine, Newspaper

        template <typename ... TMedia>
        class Bookstore
        {
        private:
            using SimpleStock = std::vector<std::variant<Book, Movie>>;
        ...
        public:
            ...
            // template member method  // T == Einen der Typen von TMedia
            template <typename T>
            void addMedia(const T& media) {
        ...
        void testExercise_02a() {
            ...
            using AnotherBookstore = Bookstore<Book, Movie, CD>;
...
{
    Exercises_UtilityClasses::Exercise_02_Simple::test_ex();
    return;
